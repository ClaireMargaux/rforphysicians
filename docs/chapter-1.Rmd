...
```{r}
# Imagine a data set with 3 groups: control, treatment 1, treatment 2, coded initially as 1, 2, and 3
df <- data.frame(
  Group = c(1, 2, 3, 2, 3),
...
# If you used this variable in a regression, the model would assume a numeric order (control < treatment 1 < treatment 2), which is wrong.
