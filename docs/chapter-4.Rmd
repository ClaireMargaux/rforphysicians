...
✏️ N°4 Exercise on comparing proportions: Test the association between cigar smoking (`SMQ680`) and pipe smoking (`SMQ690`).

✏️ N°5 Exercise on comparing more than two groups: Compare mean BMI (`BMXBMI`) across age groups.
